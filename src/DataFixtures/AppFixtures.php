    ...
    public function loadAdherent()
    {
        ...
        for ($i = 0; $i < 25; $i++) {
            ...
            $adherent->setNom($this->faker->lastName())
                ...
                ->setPassword($this->passwordEncoder->encodePassword($adherent, 'sharingan.'));
        ...
        $adherentAdmin->setNom("Rolland")
            ...
            ->setPassword($this->passwordEncoder->encodePassword($adherentAdmin, 'sharingan.'))
            ->setRoles($rolesAdmin);
        ...
        $adherentManager->setNom("Durand")
            ...
            ->setPassword($this->passwordEncoder->encodePassword($adherentManager, 'sharingan.'))
